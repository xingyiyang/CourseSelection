...
<head>
    ...
    <link rel="SHORTCUT ICON" href="${pageContext.request.contextPath}/static/images/logo.ico">
    <link rel="BOOKMARK" href="${pageContext.request.contextPath}/static/images/logo.ico">
